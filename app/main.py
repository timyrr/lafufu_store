...
stmt_bear_product = insert(Product).values(
        id=6,
        title='Lafufu-игрушка, укравшая флаг!!!',
        description='''
✨━━━━━━━━━━━━━━━✨
Милая плюшевая игрушка Lafufu в нежно-голубом костюмчике
✨━━━━━━━━━━━━━━━✨

💖 Очаровательная игрушка с очень милым личиком, которая может обронить флаг, когда уйдет с нашего магазина (надеемся, что это никогда не произойдет!)
Она станет прекрасным украшением комнаты, милым подарком и любимым элементом коллекции 🧸💞

🌸━━━━━━━━ Особенности ━━━━━━━━🌸
🐰 Нежный голубой цвет
🚩 Держит у себя в кармашке красивый флаг, который так нужен каждому из нас
